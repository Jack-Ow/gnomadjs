...
p.add_argument(
    "--output-url", help="URL to write Hail table to", default="s3://npmchorus-gnomad/SG10K_health_mini.r1.sites.vep.ht"
)
...
SG10K_VCF_URL = "s3://npmchorus-gnomad//data/13000026/data/SG10K_Health_mini/gatk4_hg38.jc.vcf/SG10K_Health_mini.postVQSR.jc.vcf.gz"
mt = hl.import_vcf(SG10K_VCF_URL, force_bgz=True, min_partitions=2000, skip_invalid_loci=True)
